	...
	<div id="container" class="bungloon-outline" data-background="<?php echo e(asset('public/style/login/img/bg.jpg')); ?>">
		<div class="box box-sm">
			<div class="logo">
                ...
                <img  src="<?php echo e(asset('public/style/login/img/logo.png' )); ?>" alt="logoFutnet">
			</div>
			<div class="form">
				<form method="POST" action="<?php echo e(route('cekLogin.admin')); ?>">
					...
					<div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
						<span class="form-icon"><i class="fa fa-lock"></i></span>
						<input type="password" name="passwordconfrim" class="form-input" placeholder="Confirm Password">
					</div>
                    <?php if($errors->has('password')): ?>
                            <span style="color:red;">
                                <?php echo e($errors->first('password')); ?>
					...
					<div class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
						<span class="form-icon"><i class="fa fa-lock"></i></span>
						<input type="text" name="address" class="form-input" placeholder="Alamat">
					</div>
