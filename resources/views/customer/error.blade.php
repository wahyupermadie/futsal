...
<head>
    ...
    <!-- Waves Effect Css -->
    <link href="{{ asset('style/plugins/node-waves/waves.css')}}"  >
...
<body class="four-zero-four">
    <div class="four-zero-four-container">
        ...
        <div class="button-place">
            <a href="{{url('/home')}}" class="btn btn-default btn-lg waves-effect">GO TO HOMEPAGE</a>
        </div>
    </div>
    ...
    <script src="{{asset('style/plugins/node-waves/waves.js')}}"></script>
</body>
